...
print("Today we sold {} red, {} yellow, {} green, {} white, {} black, {} blue and {} purple threads.".format(colour_count("red"), colour_count("yellow"), colour_count("green"), colour_count("white"), colour_count("black"), colour_count("blue"), colour_count("purple")))
