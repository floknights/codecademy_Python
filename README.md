...
bfs.py = practicing algorithms & data structures (tree implementation, tree traversal, queues, deque objects)  
dfs.py = practicing algorithms & data structures (tree implementation, tree traversal, recursion, stacks, deque objects, tuples)  
