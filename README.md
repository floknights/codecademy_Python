...
bfs.py = practicing algorithms & data structures (breadth-first search, trees, queues, deque objects)  
dfs.py = practicing algorithms & data structures (depth-first search, trees, recursion, stacks, tuples)  
rbs_1.py = practicing algortithms & data structures (recursive binary search, recursion)  
