...
breadth_first_search.py = practicing algorithms & data structures (tree implementation, tree traversal, queues, deque objects)  
depth_first_search.py = practicing algorithms & data structures (tree implementation, tree traversal, recursion, stacks, deque objects, tuples)  
