...
tries.py = practicing data structures (prefix trees/tries, pointers)  
range_sum.py = practicing data structures (binary indexed trees)  
update_element.py = practicing data structures (binary indexed trees)  
binary_indexed_tree = practicing data structures (binary indexed trees)  
