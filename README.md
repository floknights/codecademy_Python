...
polynomial_rolling_hash.py = practicing string search algorithms (hashing)  
rabin_karp.py = practicing string search algorithms (hashing)  
rabin_karp_multiple.py = practicing string search algorithms (hashing)  
rabin_karp_2d.py = practicing string search algorithms (hashing)  
knuth_morris_pratt.py = practicing string search algorithms ()  
